class GameComponent {
  ...
  create() {
    ...
    this.audioButton = this.add.button(
      Ball._WIDTH - this.pauseButton.width - 8 * 2,
      8,
      'button-audio',
      this.manageAudio,
      this
    ...
    this.levelText = this.game.add.text(
      120,
      10,
      'Level: ' + this.level + ' / ' + this.maxLevels,
      this.fontSmall
    );
    ...
    this.permissionButton = this.add.button(
      Ball._WIDTH - this.pauseButton.width - 8 * 16,
      8,
      'button-pause',
      this.askMotionPermit,
      this
    );
    this.pauseButton.anchor.set(1, 0);
